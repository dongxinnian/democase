...
function getALLCloneChildById(id,j,children)
{
    if (!children) 
        {
            var children = [];
   ...
   for (var i = 0; i < dataList.length; i++) 
   {
          ...
          if(dataList[i].id == id)
        {
           ...
           if (childs.length) 
            {
                childs.forEach(function(value,index){
                    getALLCloneChildById(value.id,++j,children);
                })
            };
        }
    }
...
//     console.log(objList);
//     var data = [];
//     for (var i = 0,j=0; i < objList.length; i++) {
        
//         if(objList[i].parentId == parentId)
//         {
//             for(var key in objList[i])
//             {
//                 data[j] = data[j] || {};
//                 data[j][key] = objList[i][key];
//             }
//             j++;
